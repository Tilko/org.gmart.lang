...
public class JavaPrimitives {
	...
	public static  class Primitive {
		...
		@Setter @Getter private String nameBoxedShort;
...
//		}
	...
	public final static String[] primitiveBoxedTypes = new String[] {
			...
			"Double",
			"Boolean"};
	public final static String[] primitiveShortBoxedTypes = new String[] {
			"Char",
			"Byte",
			"Short",
			"Int",
	...
	public static boolean isBoxedPrimitive(Object obj) {
		return getPrimitiveFromBoxedOrUnboxedTypeName(obj.getClass().getSimpleName()) != null;
	}
	static {		
		...
		for(int i = 0; i < primitiveTypes.length; i++) {
			...
			primitive.setNameBoxedShort(primitiveShortBoxedTypes[i]);
